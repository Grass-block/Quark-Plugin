...
public final class RealisticMinecart extends PackageModule {
    ...
    @Override
    public void enable() {
        TaskService.global().timer(TASK_ID, 1, 1, this::tick);
    }
    ...
    public static final class VirtualMinecartAgent {
        ...
        static VirtualMinecartAgent get(RealisticMinecart holder, Minecart minecart) {
            return AGENTS.computeIfAbsent(minecart, minecart1 -> new VirtualMinecartAgent(holder, minecart1));
        }
        ...
        public void tick() {
            ...
            if (velocity.length() > 0 && this.holder.getConfig().getBoolean("auto-align")) {

...
public interface Queries {
    ...
    static void quarkStats(QueryHandler handler) {
        ...
        handler.register("quark_version",Quark::getVersion);
        handler.register("quark_framework_version",new ValueSupplier(Quark.CORE_ID));
        handler.register("quark_text_engine_version",new ValueSupplier(Quark.TEXT_ENGINE_ID));
        handler.register("build_time",new ValueSupplier(Quark.METADATA.getProperty("build-time")));
    }

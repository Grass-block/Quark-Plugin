...
@CommandProvider(AC_PotatoWar.QueryCommand.class)
public final class AC_PotatoWar extends PackageModule {
    ...
    public void onPlayerJoin(final PlayerJoinEvent event) {
        String temp = getLanguage().buildTemplate(LocaleService.locale(event.getPlayer()), "announce-ui");
    ...
    public static final class QueryCommand extends ModuleCommand<AC_PotatoWar> {
        ...
        public void onCommand(CommandSender sender, String[] args) {
            ...
            var list = query(sender.getName(), template, args.length > 0).toString();
            var temp = getLanguage().buildTemplate(LocaleService.locale(sender), "ui").formatted(list);

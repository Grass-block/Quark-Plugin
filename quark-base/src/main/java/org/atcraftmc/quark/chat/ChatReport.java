...
public final class ChatReport extends PackageModule {
    ...
    public static final class ChatReportCommand extends ModuleCommand<ChatReport> {
        ...
        public void onCommand(CommandSender sender, String[] args) {
            ...
            handle.getLanguage().sendMessage(sender, "success", rec[1], rec[3]);
            handle.record.addLine(SharedObjects.DATE_FORMAT.format(new Date()), args[0], sender.getName(), rec[0], rec[1], rec[2]);

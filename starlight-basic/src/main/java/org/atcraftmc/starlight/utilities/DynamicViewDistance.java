...
public final class DynamicViewDistance extends PackageModule implements PluginCommandExecutor {
    ...
    public void enable() {
        ...
        TaskService.async().timer("view-distance:calc", 1, getConfig().value("calc-period").intValue(), () -> {
